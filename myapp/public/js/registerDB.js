...
window.addEventListener("load", function () {
    ...
    let buttonUserImg = qs("button.userImg");
    let form = qs("form");
    ...
    inputMulter.addEventListener("change", function (event) {
        // Captura la img que subio el usuario y la previsualiza.
    ...
    inputMulter.addEventListener("change", function (event) {
            ...
            if (event.srcElement.files[0].type == undefined || event.srcElement.files[0].type == "image/jpeg" || event.srcElement.files[0].type == "image/png" || event.srcElement.files[0].type == "image/gif") {
                ...
                qs("small.multer").innerText = "Ingresa un formato de imagen válido (jpeg, jpg, png, gif)"
                errors.avatar = 1
            };
        });
    ...
    button.addEventListener("click", function (event) {
        ...
        // ======================= USERNAME CONTROL ====================================
        // Evita que se envie si el usuario nunca hizo blur en el innput.
